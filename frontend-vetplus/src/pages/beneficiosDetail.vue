  ...
  <div class="bg-white min-h-screen">
    <main class="max-w-6xl mx-auto px-6 py-12 lg:py-20">
      ...
      <button @click="$router.back()"
        ...
        <span class="text-xl group-hover:-translate-x-1 transition-transform"><i
      ...
      <div v-else-if="beneficio" class="space-y-8">
        ...
        <!-- Hero Section -->
        <div
          class="bg-gradient-to-br from-emerald-50 via-white to-sky-50 rounded-3xl border border-emerald-100 overflow-hidden shadow-xl">
          <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 p-8 lg:p-16 items-center">
            ...
            <div class="flex justify-center lg:justify-start order-2 lg:order-1">
              <div class="relative">
                <div
                  class="absolute inset-0 bg-gradient-to-br from-emerald-200 to-sky-200 rounded-3xl blur-2xl opacity-40 -z-10 scale-110">
                </div>
            ...
            <div class="order-1 lg:order-2">
              <div
                class="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-xs font-bold tracking-widest uppercase mb-4">
                <i class="fa-solid fa-star"></i>
                Beneficio Exclusivo
              </div>
              <h1
                class="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tighter leading-[0.9] text-slate-900 mb-6">
                {{ beneficio.name }}
              </h1>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <!-- Dirección -->
          <div
            class="group bg-white rounded-2xl border border-slate-200 hover:border-emerald-300 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-100">
            <div class="flex items-center gap-3 mb-4">
              <div
                class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center text-emerald-600 text-xl group-hover:scale-110 transition-transform">
          ...
          <!-- Teléfono -->
          <div
            class="group bg-white rounded-2xl border border-slate-200 hover:border-sky-300 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-sky-100">
            <div class="flex items-center gap-3 mb-4">
              <div
                class="w-12 h-12 bg-sky-100 rounded-xl flex items-center justify-center text-sky-600 text-xl group-hover:scale-110 transition-transform">
                <i class="fa-solid fa-phone"></i>
              </div>
              <h3 class="text-lg font-bold text-slate-900">Teléfono</h3>
            </div>
            <a :href="`tel:${beneficio.telefono.join('')}`"
              class="text-slate-600 hover:text-sky-600 text-lg font-semibold transition-colors">
          ...
          <!-- Web -->
          <div
            class="group bg-white rounded-2xl border border-slate-200 hover:border-violet-300 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-violet-100">
            <div class="flex items-center gap-3 mb-4">
              <div
                class="w-12 h-12 bg-violet-100 rounded-xl flex items-center justify-center text-violet-600 text-xl group-hover:scale-110 transition-transform">
                <i class="fa-solid fa-globe"></i>
              </div>
              <h3 class="text-lg font-bold text-slate-900">Sitio Web</h3>
            </div>
            <a :href="beneficio.web" target="_blank"
              class="text-violet-600 hover:text-violet-700 hover:underline font-medium text-sm break-all line-clamp-2 transition-colors">
              {{ beneficio.web.join(', ') }}
            </a>
          </div>
          ...
          <!-- Contacto -->
          <div
            class="group bg-white rounded-2xl border border-slate-200 hover:border-amber-300 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-amber-100">
            <div class="flex items-center gap-3 mb-4">
              <div
                class="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center text-amber-600 text-xl group-hover:scale-110 transition-transform">
