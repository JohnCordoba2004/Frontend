...
export const EDAD_PERRO = ['3 a 11 meses', '1 a 4 años', '5 a 6 años', '7 a 8 años', '9 o más años']
export const EDAD_GATO = ['3 a 11 meses', '12 meses a 4 años', '5 a 8 años', '9 a 12 años']
...
export const useMascotaStore = defineStore('mascota', {
  state: () => ({
    datosMascota: {
      ...
      comoSupo: '',
      detalleComoSupo: '',
      planSeleccionado: '', // 'Diamante' | 'Esmeralda' | 'Silver' (Silver solo Perros en tabla)
