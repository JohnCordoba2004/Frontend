  ...
  <section class="bg-white rounded-3xl shadow-lg p-8">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-10">
      <div>
        ...
        <p class="text-gray-600 mt-1">Crea, edita o elimina otros</p>
      </div>
    ...
    <div class="grid lg:grid-cols-12 gap-10">
      ...
      <div class="lg:col-span-7">
        <div class="flex items-center justify-between mb-6">
          <h3 class="text-xl font-semibold text-gray-800">Listado</h3>
          <span class="text-sm text-gray-500">{{ otros.length }} registradas</span>
        </div>
